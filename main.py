...
def move_tiles(window, tiles, clock, direction):
    ...
    if direction == "left":
        ...
        move_check = (
            lambda tile, next_tile: tile.x > next_tile.x + RECT_WIDTH + MOVE_SPEED
        )
        ceil = True
        ...
        merge_check = lambda tile, next_tile: tile.x < next_tile.x - MOVE_SPEED
        move_check = (
            lambda tile, next_tile: tile.x + RECT_WIDTH + MOVE_SPEED < next_tile.x
        )
        ceil = False
    elif direction == "up":
        ...
        move_check = (
            lambda tile, next_tile: tile.y > next_tile.y + RECT_HEIGHT + MOVE_SPEED
        )
        ceil = True
    elif direction == "down":
        sort_func = lambda x: x.row
        ...
        merge_check = lambda tile, next_tile: tile.y < next_tile.y - MOVE_SPEED
        move_check = (
            lambda tile, next_tile: tile.y + RECT_HEIGHT + MOVE_SPEED < next_tile.y
        )
        ceil = False
